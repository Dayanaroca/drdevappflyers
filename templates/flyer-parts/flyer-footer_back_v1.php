    ...
    <tr>
        <td  style="text-align:left; vertical-align:middle; padding:10px 30px 9px 30px;">
            <?php if (!empty($brand_phone)): ?>
                <a href="tel:<?php echo preg_replace('/\s+/', '', $brand_phone); ?>" style="display:inline-block; font-weight: 500; text-decoration:none; line-height:11px;">
            ...
            <?php if (!empty($brand_email)): ?>
                <a href="mailto:<?php echo sanitize_email($brand_email); ?>" style="display:inline-block; font-weight: 500; text-decoration:none; line-height:11px;">
                    <span style="font-weight: 500; color: #000; font-size: 11px; font-style: italic;">
            ...
            <?php if (!empty($others_links)): ?>
                <a href="<?php echo  esc_url($others_links); ?>" style="display:inline-block; font-weight: 500; text-decoration:none; line-height:11px;;">
                    <span style="font-weight: 500; color: #000; font-size: 11px; font-style: italic;">
