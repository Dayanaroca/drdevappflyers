...
<table width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin:0; padding:0; width:100%; position:relative;">
    <tr>
        <td style="padding:0; margin:0; position:relative; min-height:<?php echo $size_header_front; ?>;">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" 
                   style="background-color:rgba(0,0,0,0.6); width:100%; height:<?php echo $size_header_front; ?>; box-sizing:border-box; position:relative; z-index:1;">
                <tr>
                ...
                <tr>
                    <td valign="bottom" style="vertical-align:bottom; padding:0px 30px 15px 30px;">
